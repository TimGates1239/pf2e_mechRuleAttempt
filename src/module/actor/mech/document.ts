...
class MechPF2e<TParent extends TokenDocumentPF2e | null = TokenDocumentPF2e | null> extends ActorPF2e<TParent> {
    ...
    /** Mech dimensions are specified for all three axes and usually do not form cubes */
    ...
    override prepareBaseData(): void {
        ...
        // Set the prototype token's dimensions according to the mech dimensions
...
interface MechPF2e<TParent extends TokenDocumentPF2e | null = TokenDocumentPF2e | null> extends ActorPF2e<TParent> {
    readonly _source: MechSource;
    system: MechSystemData;
