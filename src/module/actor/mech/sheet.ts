...
import type { MechSystemSchema } from "./data.ts";

export class MechSheetPF2e extends ActorSheetPF2e<MechPF2e> {
    static override get defaultOptions(): ActorSheetOptions {
        const options = super.defaultOptions;
        return {
            ...options,
            classes: [...options.classes, "mech"],
            width: 670,
            height: 520,
            tabs: [{ navSelector: ".sheet-navigation", contentSelector: ".sheet-content", initial: "details" }],
            template: `systems/${SYSTEM_ID}/templates/actors/mech/sheet.hbs`,
        };
    }
...
interface MechSheetData extends ActorSheetDataPF2e<MechPF2e> {
